...
export const getBio = (templateInfo, personality) => {
  ...
  const name =
    personality.names[Math.floor(Math.random() * personality.names.length)]
  const city =
    personality.cities[Math.floor(Math.random() * personality.cities.length)]
  const weapon =
    personality.weapons[Math.floor(Math.random() * personality.weapons.length)]
  const hobby =
    personality.hobbies[Math.floor(Math.random() * personality.hobbies.length)]
  const profession =
    personality.professions[
      Math.floor(Math.random() * personality.professions.length)
    ]
...
export const getPersonalityQuestionsAndAnswers = (personality) => {
  const question =
    personality.generalPersonalityQuestions[
      Math.floor(Math.random() * personality.generalPersonalityQuestions.length)
    ]
  const answer =
...
export const getHobbyQuestionsAndAnswers = (personality) => {
  const question =
    personality.hobbyQuestions[
      Math.floor(Math.random() * personality.hobbyQuestions.length)
    ]
  const answer =
    personality.hobbyAnswers[
      Math.floor(Math.random() * personality.hobbyAnswers.length)
    ]
  return { question, answer }
}
...
export const getRelationshipQuestionsAndAnswers = (personality) => {
  const question =
    personality.relationshipQuestions[
      Math.floor(Math.random() * personality.relationshipQuestions.length)
    ]
  const answer =
    personality.relationshipAnswers[
      Math.floor(Math.random() * personality.relationshipAnswers.length)
    ]
  return { question, answer }
}
...
function loadBioFromStorage(itemName) {
  ...
  if (fullBioStr) return JSON.parse(fullBioStr)
  return null
}
...
function BioPage({ templateInfo, personality }) {
  ...
  const [fullBio, setFullBio] = React.useState(
    loadBioFromStorage(`${templateInfo.id}_bio`) ||
      getBio(templateInfo, personality),
  )

  React.useEffect(() => {
    localStorage.setItem(`currentTemplateId`, templateInfo.id)
    localStorage.setItem(`${templateInfo.id}_bio`, JSON.stringify(fullBio))
  }, [fullBio])
          ...
          <div className={styles["inner-container"]}>
            ...
            <div className={styles.section}>
              ...
              <input
                ...
                onChange={(e) =>
                  setFullBio({ ...fullBio, ...{ name: e.target.value } })
                }
              />
            </div>
            ...
            <div className={styles.section}>
              ...
              <select
                ...
                onChange={(e) =>
                  setFullBio({ ...fullBio, ...{ voiceKey: e.target.value } })
                }
              >
            ...
            <div className={styles.section}>
              ...
              <input
                ...
                onChange={(e) =>
                  setFullBio({ ...fullBio, ...{ greeting: e.target.value } })
                }
              />
            </div>
            ...
            <div className={styles.section}>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setFullBio({ ...fullBio, ...{ description: e.target.value } })
                }
              />
            </div>
