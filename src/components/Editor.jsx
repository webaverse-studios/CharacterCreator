...
export default function Editor({templateInfo, initialTraits, animationManager, effectManager}) {
  ...
  return(
    ...
    <Selector animationManager={animationManager} templateInfo={templateInfo} effectManager={effectManager}/>
  </Fragment>
  );
}
